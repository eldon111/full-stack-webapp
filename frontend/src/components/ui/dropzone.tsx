...
>(({ className, ...props }, ref) => (
  <Primitive.div ref={ref} className={cn('grid place-items-center gap-1.5', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <Primitive.h3 ref={ref} className={cn('font-medium leading-none tracking-tight', className)} {...props} />
));
